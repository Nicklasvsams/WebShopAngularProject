...
namespace WebShopLibrary.DataAccessLayer.Migrations
{
    ...
    [Migration("20220225065510_Monitor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebShopLibrary.DataAccessLayer.Database.Entities.Products.Monitors.Monitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebShopLibrary.DataAccessLayer.Database.Entities.Transactions.Purchase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ProductId = 1,
                            PurchaseDate = new DateTime(2022, 2, 25, 7, 55, 9, 895, DateTimeKind.Local).AddTicks(772),
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            ProductId = 2,
                            PurchaseDate = new DateTime(2022, 2, 25, 7, 55, 9, 897, DateTimeKind.Local).AddTicks(335),
                            UserId = 2
                        });
                });
